    ...
    <div class="container">
        <div id="ant-layout">
            <section class="search-quan">
                ...
                <form action="thucdon.php" method="GET">
                    <input name="search" type="text" placeholder="Tìm Thú Cưng Yêu Thích">
                </form>
            </section>
                        ...
                        echo '
                                    <div class="box">
                                        <a href="thucdon.php?id_category=' . $item['id'] . '">
                                            <p>' . $item['name'] . '</p>
                                            <div class="bg"></div>
                                              <img src="images/bg/cho' . $count . '.jpg" alt="" class="category-image">
                                        </a>
                                    </div>
                                    ';
                                $count++;
        ...
        <section class="main">
            ...
            <section class="restaurants">
                <div class="title">
                    <h1>SHOP THÚ CƯNG <span class="green"></span></h1>
                </div>
